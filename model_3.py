...
class FNNModel(nn.Module):
    ...
    def init(self, vocab_size, embedding_dim, context_size, h, tie_weights=False):
        super(FNNModel, self).init()
    ...
    def initweights(self):
        initrange = 0.1
        nn.init.uniform(self.embeddings.weight, -initrange, initrange)
        nn.init.zeros(self.linear2.weight)
        nn.init.uniform(self.linear2.weight, -initrange, initrange)
